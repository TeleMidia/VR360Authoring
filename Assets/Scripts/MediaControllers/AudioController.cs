...
public class AudioController : MediaControllerAbstract
{
    ...
    /// Configures the audioContainer to load the audio with its configurations
    /// </summary>
    ...
    /// <summary>
    /// Inherited from MediaControllerAbstract
    /// Playing for the audio is to play the audioContainer
    /// </summary>
    ...
    /// <summary>
    /// Inherited from MediaControllerAbstract
    /// Stopping for the audio is to stop the audioContainer
    /// </summary>
