...
public class ImageController : MediaControllerAbstract
{
    ...
    /// Loads the image creating a material from a texture and assigning that material to the object mesh renderer
    /// </summary>
    ...
    /// <summary>
    /// Inherited from MediaControllerAbstract
    /// Playing for the image consists in enabling its MeshRenderer
    /// </summary>
    ...
    /// <summary>
    /// Inherited from MediaControllerAbstract
    /// Stopping for the image consists in disabling its MeshRenderer
    /// </summary>
