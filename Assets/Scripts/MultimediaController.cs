...
public class MultimediaController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        video1.GetComponent<Video360Controller>().AddMedia(video360PreviewPrefab, start_time: 5, duration: 10, r: 4, theta: 0, phi: 0, controller:video2);
        ...
        */
        ...
        this.video1.GetComponent<Video360Controller>().StartVideo360();
    }
